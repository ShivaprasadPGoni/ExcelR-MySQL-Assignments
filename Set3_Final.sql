...
DELIMITER //
Create procedure order_status1( IN t_year INT,
                                    IN t_month INT )
	BEGIN 
		select orderNumber,
               orderdate,
...
DELIMITER //
CREATE PROCEDURE cancelled_order1( )
	BEGIN
...
CREATE PROCEDURE customer_status1( cust_No INT )    
    BEGIN
		SELECT CASE
			   WHEN amount < 25000 THEN 'Silver'
			   WHEN amount BETWEEN 25000 AND 50000 THEN 'Gold'
